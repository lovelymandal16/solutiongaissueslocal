...
## Environments
- Preview: https://main--solutiongaissueslocal--lovelymandal16.hlx.page/
- Live: https://main--solutiongaissueslocal--lovelymandal16.hlx.live/
...
1. Open the `solutiongaissueslocal` directory in your favorite IDE and start coding :)
